...
public class Convert {
  ...
  /**
   * read 1 byte from the given byte array at the specified position
   * 
   * @param position
   * @param data
   * @return
  ...
  /**
   * update a byte value in the given byte array at the specified position
   * 
   * @param data     a byte array
   * @param value    the value to be copied into the data[]
   * @param position the position of tht value in data[]
  ...
  public static void setByteValue(byte value, int position, byte[] data)
      throws java.io.IOException {
    /*
     * create a new data output stream to write data to
     * underlying output stream
     */
