...
public class BatchInsert {
    ...
    public static void main(String[] args) throws PageUnpinnedException, PagePinnedException, PageNotFoundException,
            HashOperationException, BufMgrException, IOException {
    ...
    private static void runInterface(String dataFileName, String columnarFile, int numColumns) throws IOException {
        ...
        try {
            ...
            // Columnarfile cf = new Columnarfile(columnarFile, numColumns, types, sizes,
            // names);
            
            Columnarfile cf = new Columnarfile(columnarFile, numColumns, types, names);
